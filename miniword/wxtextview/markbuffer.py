...
#
# Neuster Stand: L�schen von Marken ist fehlerhaft. Die Korrektur
# durch insert funktioniert in vielen F�llen nicht.
#
# L�sungskonzept: remove_mark sollte zwei R�ckgabewerte haben, den
# Baum und den �bertrag. Der �bertrag gibt den Wert, um den die
# folgende Node nach rechts verschoben werden muss.
#
# �berlegungen dazu: Das Problem tritt immer an Grenzen auf und muss
# an der Stelle korrigiert werden, an der die beiden angrenzenden
# Teilb�ume zusammenlaufen. Die Korrektur besteht in einem Aufruf
# insert(r, 0, delta), d.h. in den rechten TReilbaum wird an der
# Stelle 0 die Korrektur um Delta eingef�gt. Elegant w�re, hierf�r
